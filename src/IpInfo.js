const IpInfo = () => {
  return (
    ...
    >
      <ul className="flex flex-col items-center py-4 md:justify-around md:flex-row">
        <li className="my-2 lg:border-r md:pr-4 md:text-left">
        ...
        <li className="my-2 md:pr-4 md:text-left">
